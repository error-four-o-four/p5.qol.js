...
function ot() {
  const t = "resize", e = h.call(this, "resizeDelay"), i = D(rt.bind(this), e);
...
const ft = (t) => {
  at(t), Y(t), dt(t), ht(t), B(t), tt(t), ct(t), globalThis.process === void 0 && !t.disableFriendlyErrors && console.log("%cp5.QoL.js", "color: white; background: #ff1493;");
};
